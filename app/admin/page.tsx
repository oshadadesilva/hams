...
const auditLogs = [
    { id: "1", time: "2026-04-13 09:23", user: "Admin Jane Smith", action: "User Created", details: "Created doctor account for Dr. Chen" },
    { id: "2", time: "2026-04-13 08:15", user: "Dr. Sarah Chen", action: "Availability Updated", details: "Set Monday-Friday 9-5" },
    { id: "3", time: "2026-04-12 16:42", user: "System", action: "Appointment Booked", details: "Patient John Doe with Dr. Okonkwo" },
];
                                ...
                                <tbody className="divide-y divide-slate-100">
                                    {dummyUsers.map((user) => (
                                        <tr key={user.id} className="text-slate-700">
                                            ...
                                            <td className="py-3">
                                                <span className={`inline-block rounded-full px-2 py-1 text-xs font-medium ${user.status === "Active" ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"
                                                    }`}>
                                                    {user.status}
                                                </span>
                                            </td>
